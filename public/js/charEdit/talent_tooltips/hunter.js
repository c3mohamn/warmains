...
hunter_ranks[i] = [
  "<span style=text-align:left;float:left;>10% of base mana</span><span style=text-align:right;float:right;>100 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>2 min cooldown</span><br>\
...
//Aimed Shot - Marksmanship TALENT DIFFERENT has trainable hunter_rankss
hunter_ranks[i] = [
...
hunter_ranks[i] = [
  "<span style=text-align:left;float:left;>8% of base mana</span><span style=text-align:right;float:right;>15 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>30 sec cooldown</span><br><span style=text-align:left;float:left;>Requires Ranged Weapon</span><br/>\
...
//Counterattack - Survival TALENT DIFFERNT has trainable hunter_rankss
hunter_ranks[i] = [
  "<span style=text-align:left;float:left;>3% of base mana</span><span style=text-align:right;float:right;>Melee range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>5 sec cooldown</span><br>\
	A strike that becomes active after parrying an opponent's attack. This attack deals 40 damage and immobilizes the target for 5 sec. Counterattack cannot be blocked, dodged, or parried.<br><br>"
];i++;
...
//Wyvern Sting - Survival TALENT DIFFERENT has trainable hunter_rankss
hunter_ranks[i] = [
  "<span style=text-align:left;float:left;>8% of base mana</span><span style=text-align:right;float:right;>5-35 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>1 min cooldown</span><br>\
	A stinging shot that puts the target to sleep for 12 sec. Any damage will cancel the effect. When the target wakes up, the Sting causes 2460 Nature damage over 6 sec. Only one Sting per Hunter can be active on the target at a time.<br><br>"
];i++;
